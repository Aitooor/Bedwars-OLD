...
public class UpgradesConfig extends ConfigManager {
    public UpgradesConfig(final String s, final String s2) {
        ...
        yml.addDefault("default-upgrades-settings.menu-content", Arrays.asList("upgrade-swords,10", "upgrade-armor,11", "upgrade-miner,12", "upgrade-forge,13", "upgrade-heal-pool,14", "upgrade-dragon,15", "category-traps,16", "separator-glass,18,19,20,21,22,23,24,25,26", "trap-slot-first,30", "trap-slot-second,31", "trap-slot-third,32"));
        ...
        if (this.isFirstTime()) {
            ...
            this.addDefaultDisplayItem("upgrade-swords.tier-1", "IRON_SWORD", 0, 1);
            ...
            this.addDefaultDisplayItem("upgrade-armor.tier-1", "IRON_CHESTPLATE", 0, 1);
            ...
            this.addDefaultDisplayItem("upgrade-armor.tier-2", "IRON_CHESTPLATE", 0, 2);
            ...
            this.addDefaultDisplayItem("upgrade-armor.tier-3", "IRON_CHESTPLATE", 0, 3);
            ...
            this.addDefaultDisplayItem("upgrade-armor.tier-4", "IRON_CHESTPLATE", 0, 4);
            ...
            this.addDefaultDisplayItem("upgrade-miner.tier-1", "GOLD_PICKAXE", 0, 1);
            ...
            this.addDefaultDisplayItem("upgrade-miner.tier-2", "GOLD_PICKAXE", 0, 2);
            ...
            this.addDefaultDisplayItem("upgrade-forge.tier-1", "FURNACE", 0, 1);
            ...
            this.addDefaultDisplayItem("upgrade-forge.tier-2", "FURNACE", 0, 2);
            ...
            this.addDefaultDisplayItem("upgrade-forge.tier-3", "FURNACE", 0, 3);
            ...
            this.addDefaultDisplayItem("upgrade-forge.tier-4", "FURNACE", 0, 4);
            ...
            this.addDefaultDisplayItem("upgrade-heal-pool.tier-1", "BEACON", 0, 1);
            ...
            this.addDefaultDisplayItem("upgrade-dragon.tier-1", "DRAGON_EGG", 0, 1);
            yml.addDefault("upgrade-dragon.tier-1.receive", Collections.singletonList("dragon: 1"));
            this.addDefaultDisplayItem("category-traps", "LEATHER", 0, 1);
            ...
            this.addDefaultDisplayItem("separator-glass", BedWars.getInstance().getForCurrentVersion("STAINED_GLASS_PANE", "STAINED_GLASS_PANE", "GRAY_STAINED_GLASS_PANE"), 7, 1);
            yml.addDefault("trap-slot-first.trap", 1);
            this.addDefaultDisplayItem("trap-slot-first", BedWars.getInstance().getForCurrentVersion("STAINED_GLASS", "STAINED_GLASS", "GRAY_STAINED_GLASS"), 8, 1);
            yml.addDefault("trap-slot-second.trap", 2);
            this.addDefaultDisplayItem("trap-slot-second", BedWars.getInstance().getForCurrentVersion("STAINED_GLASS", "STAINED_GLASS", "GRAY_STAINED_GLASS"), 8, 2);
            yml.addDefault("trap-slot-third.trap", 3);
            this.addDefaultDisplayItem("trap-slot-third", BedWars.getInstance().getForCurrentVersion("STAINED_GLASS", "STAINED_GLASS", "GRAY_STAINED_GLASS"), 8, 3);
            this.addDefaultDisplayItem("base-trap-1", "TRIPWIRE_HOOK", 0, 1);
            yml.addDefault("base-trap-1.receive", Arrays.asList("player-effect: BLINDNESS,1,5,enemy", "player-effect: SLOW,1,5,enemy"));
            this.addDefaultDisplayItem("base-trap-2", "FEATHER", 0, 1);
            yml.addDefault("base-trap-2.receive", Collections.singletonList("player-effect: SPEED,1,15,base"));
            this.addDefaultDisplayItem("base-trap-3", BedWars.getInstance().getForCurrentVersion("REDSTONE_TORCH_ON", "REDSTONE_TORCH", "REDSTONE_TORCH"), 0, 1);
            ...
            this.addDefaultDisplayItem("base-trap-4", "IRON_PICKAXE", 0, 1);
            ...
            this.addDefaultDisplayItem("separator-back", "ARROW", 0, 1);
        }
        yml.options().copyDefaults(true);
        this.save();
    }
    
    private void addDefaultDisplayItem(final String s, final String s2, final int n, final int n2) {
        ...
        this.getYml().addDefault(s + ".display-item.enchanted", false);
    }
}
